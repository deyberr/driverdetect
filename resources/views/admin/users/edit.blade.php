                  ...
                  <div class="row mt-2">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                         ...
                         <div>
                           {!! Form::select('type_id_doc', ['1'=>'cedula'], $user->type_id, ['class' => 'form-select','id'=>'i_type_id','placeholder'=>"Seleccione el tipo de identificación", 'required',  'minlength=3' ,'maxlength=50']) !!}
                         </div>
