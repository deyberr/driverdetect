<header id="page-topbar">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/logo-system.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logo-system.png') }}" alt="" height="17">
                    </span>
                </a>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-flex align-items-center ">
            <a href="{{ route('user.support') }}" class="btn header-item noti-icon h-auto waves-effect" data-toggle="support">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="{{ route('user.profile') }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('translation.Profile')</span></a>
                <a class="dropdown-item d-block" href="#" data-bs-toggle="modal" data-bs-target=".change-password"><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings">@lang('translation.Password')</span></a>
                ...
                <form method="POST" id="change-password">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                            autocomplete="new_password" placeholder="Confirme su nueva contraseña">
