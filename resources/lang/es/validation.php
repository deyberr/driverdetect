...
return [
    ...
    */
    ...
    'min' => [
        'numeric' => 'El campo :attribute debe contener al menos :min número.',
    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'minlength' => 'El Campo nombre  debe contener al menos 3 letras',
            'maxlength' => 'El campo nombre no debería tener más de 60 letras'
        ],
        'last_name' => [
            'required' => 'El Campo apellidos es requerido',
            'minlength' => 'El Campo apellidos debe contener al menos 3 letras',
            'maxlength' => 'El campo apellidos no debería tener más de 60 letras'
        ],  'email' => [
            'required' => 'El Campo correo es requerido',
            'email' => 'Esto no es un correo electronico'
         ],
         'date_of_birth' => [
            'required' => 'El Campo fecha de nacimiento es requerido',
            'date' => 'Esto no es una fecha correcta'
        ...
        'password' => [
            ...
            'required' => 'Debe seleccionar  el rol de usuario'          
            
        ],'id_user' => [
            'required' => 'El Campo documento es requerido',            
            'minlength' =>'El campo Documento debe tener un 1 caracter'
        ],'gender' => [
            'required' => 'El Campo genero es requerido',            
            'minlength' =>'El campo genero debe tener minimo 50 caracteres'
        ],'city' => [
            'required' => 'El Campo genero es requerido',            
            'minlength' =>'El campo genero debe tener minimo un caracter'
        ],
    ],
